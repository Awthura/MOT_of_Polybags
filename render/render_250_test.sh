...
python3 - <<'PYEOF'
import sys
sys.path.insert(0, "/Users/awthura/OVGU/AMS")
from pathlib import Path
try:
    from tqdm import tqdm as _tqdm
except ImportError:
...
relabel_synth.LABELS_DIR  = Path("/Users/awthura/OVGU/AMS/synth_dataset_test/labels")
relabel_synth.IMAGES_DIR  = Path("/Users/awthura/OVGU/AMS/synth_dataset_test/images")
relabel_synth.CLASSES_TXT = Path("/Users/awthura/OVGU/AMS/synth_dataset_test/classes.txt")
relabel_synth.main()
PYEOF
