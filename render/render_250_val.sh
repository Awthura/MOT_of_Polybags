...
relabel_synth.LABELS_DIR  = Path("/Users/awthura/OVGU/AMS/synth_dataset_val/labels")
relabel_synth.IMAGES_DIR  = Path("/Users/awthura/OVGU/AMS/synth_dataset_val/images")
relabel_synth.CLASSES_TXT = Path("/Users/awthura/OVGU/AMS/synth_dataset_val/classes.txt")
relabel_synth.main()
PYEOF
