...
BASE    = Path(__file__).resolve().parent if "__file__" in dir() else Path("/Users/awthura/OVGU/AMS/synthetic_polybags")
...
relabel_synth.LABELS_DIR  = Path('/Users/awthura/OVGU/AMS/synthetic_polybags/synth_dataset_mcmot/labels')
relabel_synth.IMAGES_DIR  = Path('/Users/awthura/OVGU/AMS/synthetic_polybags/synth_dataset_mcmot/images')
relabel_synth.CLASSES_TXT = Path('/Users/awthura/OVGU/AMS/synthetic_polybags/synth_dataset_mcmot/classes.txt')
relabel_synth.main()
...
from pathlib import Path
BASE = Path('/Users/awthura/OVGU/AMS/synthetic_polybags')
MOT_DIR = Path('/Users/awthura/OVGU/AMS/synthetic_polybags/synth_dataset_mcmot/mot_obb')
